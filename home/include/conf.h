...
#define BUTTON_HEIGHT_REL (0.15)
#define ADD_WIDGET_BUTTON_TEXT_MIN 328 86
#define ADD_VIEWER_PREVIEW_WIDTH 234
#define ADD_VIEWER_PREVIEW_HEIGHT 234
#define ADD_VIEWER_PREVIEW_IMAGE_WIDTH 206
#define ADD_VIEWER_PREVIEW_IMAGE_HEIGHT 206
#define ADD_VIEWER_PREVIEW_LINE_WIDTH (ADD_VIEWER_PREVIEW_WIDTH)
#define ADD_VIEWER_PREVIEW_LINE_HEIGHT (ADD_VIEWER_PREVIEW_HEIGHT)
#define ADD_VIEWER_TEXT_TOP_WIDTH 156 //174
#define ADD_VIEWER_TEXT_BOTTOM_WIDTH 205 //234
#define ADD_VIEWER_TEXT_HEIGHT 39
#define ADD_VIEWER_PREVIEW_PAD_ITEM_H 5
#define ADD_VIEWER_PREVIEW_PAD_ITEM_V 0
#define ADD_VIEWER_PREVIEW_PAD_H (63-ADD_VIEWER_PREVIEW_PAD_ITEM_H)
#define ADD_VIEWER_PREVIEW_PAD_V 0
#define ADD_VIEWER_PAGE_WIDTH (ADD_VIEWER_PREVIEW_PAD_ITEM_H+ADD_VIEWER_PREVIEW_WIDTH)
#define ADD_VIEWER_PAGE_HEIGHT ADD_VIEWER_PREVIEW_HEIGHT
#define ADD_VIEWER_PAD 1
#define ADD_VIEWER_OVERLAP -2
#define ADD_VIEWER_HEIGHT_PAD_TOP 27
#define ADD_VIEWER_HEIGHT_PAD_BOTTOM 21
